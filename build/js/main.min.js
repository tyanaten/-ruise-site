...
var emailError = submitButton.closest('form').querySelector('div[data-error-message="email"]');
var emailInput = submitButton.closest('form').querySelector('input[type="email"]');
var checkbox = submitButton.closest('form').querySelector('input[type="checkbox"]');
var checkboxMark = submitButton.closest('form').querySelector('.custom-checkbox__mark');
...
var INITIAL_LATITUDE = 59.9387561;
var INITIAL_LONGITUDE = 30.323106;
var ZOOM = 16;
var ymaps = window.ymaps;
var map = document.querySelector('[data-map-state="no-js"]');
...
var OPEN_STATE = 'open';
var CLOSE_STATE = 'closed';
var scrollButtons = document.querySelectorAll('[data-scroll-button]');
var navToggle = document.querySelector('.main-header__toggler');
var changedHeaderElements = document.querySelectorAll('[data-header-state="no-js"]');
var menu = document.querySelector('.main-header__wrapper');
var setHeaderState = function setHeaderState(state) {
  changedHeaderElements.forEach(function (element) {
...
scrollButtons.forEach(function (button) {
  button.addEventListener('click', function (evt) {
    evt.preventDefault();
    var scrollView = document.querySelector(button.getAttribute('data-sroll-view'));
